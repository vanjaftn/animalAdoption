...
class Routes(
  ...
  private[this] lazy val controllers_AdoptionController_deletePending26_invoker = createInvoker(
    AdoptionController_5.deletePending(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.AdoptionController",
      "deletePending",
  ...
  private[this] lazy val controllers_AdoptionController_deleteApproved27_invoker = createInvoker(
    AdoptionController_5.deleteApproved(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.AdoptionController",
      "deleteApproved",
  ...
  // @LINE:129
  private[this] lazy val controllers_PhotoController_uploadPhoto66_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("uploadPhoto")))
  )
  private[this] lazy val controllers_PhotoController_uploadPhoto66_invoker = createInvoker(
  ...
  // @LINE:134
  private[this] lazy val controllers_AnimalTypeController_create68_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("animalType")))
  )
  private[this] lazy val controllers_AnimalTypeController_create68_invoker = createInvoker(
  ...
  // @LINE:135
  private[this] lazy val controllers_AnimalTypeController_readAll69_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("allAnimalTypes")))
  )
  private[this] lazy val controllers_AnimalTypeController_readAll69_invoker = createInvoker(
  ...
  // @LINE:138
  private[this] lazy val controllers_Assets_versioned70_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("assets/"), DynamicPart("file", """.+""",false)))
  )
  private[this] lazy val controllers_Assets_versioned70_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_AdoptionController_deletePending26_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_AdoptionController_deletePending26_invoker.call(AdoptionController_5.deletePending(id))
      }
  
    // @LINE:55
    case controllers_AdoptionController_deleteApproved27_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_AdoptionController_deleteApproved27_invoker.call(AdoptionController_5.deleteApproved(id))
      }
  
    // @LINE:57
    case controllers_AdoptionController_read28_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_AdoptionController_read28_invoker.call(AdoptionController_5.read(id))
      }
  
    // @LINE:59
    case controllers_AdoptionController_readByUserAndAnimalId29_route(params@_) =>
      call { 
        controllers_AdoptionController_readByUserAndAnimalId29_invoker.call(AdoptionController_5.readByUserAndAnimalId)
      }
  
    // @LINE:61
    case controllers_AdoptionController_animalAdopted30_route(params@_) =>
      call { 
        controllers_AdoptionController_animalAdopted30_invoker.call(AdoptionController_5.animalAdopted)
      }
  
    // @LINE:63
    case controllers_AdoptionController_animalAdminApproved31_route(params@_) =>
      call { 
        controllers_AdoptionController_animalAdminApproved31_invoker.call(AdoptionController_5.animalAdminApproved)
      }
  
    // @LINE:65
    case controllers_AdoptionController_adoptionExists32_route(params@_) =>
      call { 
        controllers_AdoptionController_adoptionExists32_invoker.call(AdoptionController_5.adoptionExists)
      }
  
    // @LINE:68
    case controllers_SubscriptionController_create33_route(params@_) =>
      call { 
        controllers_SubscriptionController_create33_invoker.call(SubscriptionController_4.create)
      }
  
    // @LINE:69
    case controllers_SubscriptionController_read34_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_SubscriptionController_read34_invoker.call(SubscriptionController_4.read(id))
      }
  
    // @LINE:70
    case controllers_SubscriptionController_readAll35_route(params@_) =>
      call { 
        controllers_SubscriptionController_readAll35_invoker.call(SubscriptionController_4.readAll)
      }
  
    // @LINE:72
    case controllers_SubscriptionController_delete36_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_SubscriptionController_delete36_invoker.call(SubscriptionController_4.delete(id))
      }
  
    // @LINE:74
    case controllers_SubscriptionController_subscriptionExists37_route(params@_) =>
      call { 
        controllers_SubscriptionController_subscriptionExists37_invoker.call(SubscriptionController_4.subscriptionExists)
      }
  
    // @LINE:76
    case controllers_SubscriptionController_readSubscriptionByAnimalAndUserId38_route(params@_) =>
      call { 
        controllers_SubscriptionController_readSubscriptionByAnimalAndUserId38_invoker.call(SubscriptionController_4.readSubscriptionByAnimalAndUserId)
      }
  
    // @LINE:79
    case controllers_AdminController_create39_route(params@_) =>
      call { 
        controllers_AdminController_create39_invoker.call(AdminController_8.create)
      }
  
    // @LINE:80
    case controllers_AdminController_readAll40_route(params@_) =>
      call { 
        controllers_AdminController_readAll40_invoker.call(AdminController_8.readAll)
      }
  
    // @LINE:81
    case controllers_AdminController_adminExists41_route(params@_) =>
      call { 
        controllers_AdminController_adminExists41_invoker.call(AdminController_8.adminExists)
      }
  
    // @LINE:83
    case controllers_AdminController_delete42_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_AdminController_delete42_invoker.call(AdminController_8.delete(id))
      }
  
    // @LINE:86
    case controllers_VetController_create43_route(params@_) =>
      call { 
        controllers_VetController_create43_invoker.call(VetController_7.create)
      }
  
    // @LINE:87
    case controllers_VetController_readAll44_route(params@_) =>
      call { 
        controllers_VetController_readAll44_invoker.call(VetController_7.readAll)
      }
  
    // @LINE:89
    case controllers_VetController_delete45_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_VetController_delete45_invoker.call(VetController_7.delete(id))
      }
  
    // @LINE:92
    case controllers_AdopterController_create46_route(params@_) =>
      call { 
        controllers_AdopterController_create46_invoker.call(AdopterController_1.create)
      }
  
    // @LINE:93
    case controllers_AdopterController_readAll47_route(params@_) =>
      call { 
        controllers_AdopterController_readAll47_invoker.call(AdopterController_1.readAll)
      }
  
    // @LINE:95
    case controllers_AdopterController_delete48_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_AdopterController_delete48_invoker.call(AdopterController_1.delete(id))
      }
  
    // @LINE:99
    case controllers_VetController_vetExists49_route(params@_) =>
      call { 
        controllers_VetController_vetExists49_invoker.call(VetController_7.vetExists)
      }
  
    // @LINE:102
    case controllers_VaccineController_create50_route(params@_) =>
      call { 
        controllers_VaccineController_create50_invoker.call(VaccineController_0.create)
      }
  
    // @LINE:103
    case controllers_VaccineController_readAll51_route(params@_) =>
      call { 
        controllers_VaccineController_readAll51_invoker.call(VaccineController_0.readAll)
      }
  
    // @LINE:105
    case controllers_VaccineController_delete52_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_VaccineController_delete52_invoker.call(VaccineController_0.delete(id))
      }
  
    // @LINE:107
    case controllers_VaccineController_readAllAnimalVaccines53_route(params@_) =>
      call { 
        controllers_VaccineController_readAllAnimalVaccines53_invoker.call(VaccineController_0.readAllAnimalVaccines)
      }
  
    // @LINE:110
    case controllers_LostAndFoundController_createLost54_route(params@_) =>
      call { 
        controllers_LostAndFoundController_createLost54_invoker.call(LostAndFoundController_3.createLost)
      }
  
    // @LINE:112
    case controllers_LostAndFoundController_createFound55_route(params@_) =>
      call { 
        controllers_LostAndFoundController_createFound55_invoker.call(LostAndFoundController_3.createFound)
      }
  
    // @LINE:113
    case controllers_LostAndFoundController_readAll56_route(params@_) =>
      call { 
        controllers_LostAndFoundController_readAll56_invoker.call(LostAndFoundController_3.readAll)
      }
  
    // @LINE:114
    case controllers_LostAndFoundController_readAllLost57_route(params@_) =>
      call { 
        controllers_LostAndFoundController_readAllLost57_invoker.call(LostAndFoundController_3.readAllLost)
      }
  
    // @LINE:115
    case controllers_LostAndFoundController_readAllFound58_route(params@_) =>
      call { 
        controllers_LostAndFoundController_readAllFound58_invoker.call(LostAndFoundController_3.readAllFound)
      }
  
    // @LINE:116
    case controllers_LostAndFoundController_readAllLostNotApproved59_route(params@_) =>
      call { 
        controllers_LostAndFoundController_readAllLostNotApproved59_invoker.call(LostAndFoundController_3.readAllLostNotApproved)
      }
  
    // @LINE:117
    case controllers_LostAndFoundController_readAllFoundNotApproved60_route(params@_) =>
      call { 
        controllers_LostAndFoundController_readAllFoundNotApproved60_invoker.call(LostAndFoundController_3.readAllFoundNotApproved)
      }
  
    // @LINE:119
    case controllers_LostAndFoundController_adminApproveLAF61_route(params@_) =>
      call { 
        controllers_LostAndFoundController_adminApproveLAF61_invoker.call(LostAndFoundController_3.adminApproveLAF)
      }
  
    // @LINE:122
    case controllers_PhotoController_create62_route(params@_) =>
      call { 
        controllers_PhotoController_create62_invoker.call(PhotoController_9.create)
      }
  
    // @LINE:124
    case controllers_PhotoController_adopterAddPhotos63_route(params@_) =>
      call { 
        controllers_PhotoController_adopterAddPhotos63_invoker.call(PhotoController_9.adopterAddPhotos)
      }
  
    // @LINE:125
    case controllers_PhotoController_readAll64_route(params@_) =>
      call { 
        controllers_PhotoController_readAll64_invoker.call(PhotoController_9.readAll)
      }
  
    // @LINE:127
    case controllers_PhotoController_delete65_route(params@_) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_PhotoController_delete65_invoker.call(PhotoController_9.delete(id))
      }
  
    // @LINE:129
    case controllers_PhotoController_uploadPhoto66_route(params@_) =>
      call { 
        controllers_PhotoController_uploadPhoto66_invoker.call(PhotoController_9.uploadPhoto)
      }
  
    // @LINE:131
    case controllers_PhotoController_readAllAnimalPhotos67_route(params@_) =>
      call { 
        controllers_PhotoController_readAllAnimalPhotos67_invoker.call(PhotoController_9.readAllAnimalPhotos)
      }
  
    // @LINE:134
    case controllers_AnimalTypeController_create68_route(params@_) =>
      call { 
        controllers_AnimalTypeController_create68_invoker.call(AnimalTypeController_2.create)
      }
  
    // @LINE:135
    case controllers_AnimalTypeController_readAll69_route(params@_) =>
      call { 
        controllers_AnimalTypeController_readAll69_invoker.call(AnimalTypeController_2.readAll)
      }
  
    // @LINE:138
    case controllers_Assets_versioned70_route(params@_) =>
      call(Param[String]("path", Right("/public")), params.fromPath[Asset]("file", None)) { (path, file) =>
        controllers_Assets_versioned70_invoker.call(Assets_11.versioned(path, file))
      }
  }
}
